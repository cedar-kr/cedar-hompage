...
export const historyData = [
  ...
  {
    year: 2019,
    content: ['청년 친화 강소기업 선정', '경찰청 키오스크 계약'],
  ...
  {
    year: 2017,
    content: ['가든파이브 현대시티몰 계약', '현대 백화점 무역센터 계약', '제 2 롯데타워 하이마트 계약', '현대백화점 천호점 계약'],
  ...
  {
    year: 2014,
    content: ['LG U+ MOU 체결', '서울시 챌린지 1000 프로젝트 선정', '수협은행 계약 체결'],
